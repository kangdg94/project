 ...
 * Generated at: 2021-03-08 08:30:23 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"아이디를 입력해주세요 \" name=\"userID\" maxlength=\"20\" > \n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class =\"form-group\">\n");
      out.write("\t\t\t\t\t<label for=\"userPassword\">비밀번호 </label>\n");
      out.write("\t\t\t\t\t<input type=\"password\" class=\"form-control\" placeholder=\"비밀번호를 입력해주세요 \" name=\"userPassword\" maxlength=\"20\"> \n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class =\"form-group\">\n");
      out.write("\t\t\t\t\t<label for=\"userPasswordCheck\">비밀번호 확인 </label>\n");
      out.write("\t\t\t\t\t<input type=\"password\" class=\"form-control\" placeholder=\"비밀번호를 확인해주세요 \" name=\"userPasswordCheck\" maxlength=\"20\"> \n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class =\"form-group\">\n");
      out.write("\t\t\t\t\t<label for=\"userName\">이름 </label>\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"이름을 입력해주세요 \" name=\"userName\" maxlength=\"20\"> \n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"userGender\" autocomplete=\"off\" value=\"남자\" checked>여자\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</div> \n");
      out.write("\t\t\t\t</div>\t\t\n");
      out.write("\t\t\t\t<div class =\"form-group\" >\n");
      out.write("\t\t\t\t\t<label for=\"userEmail\">이메일 </label>\n");
      out.write("\t\t\t\t\t\t<input type=\"email\" class=\"form-control\" placeholder=\"이메일을 입력해주세요 \" name=\"userEmail\" maxlength=\"20\">\n");
      out.write("\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t</div>\n");
