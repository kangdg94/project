 ...
 * Generated at: 2021-02-16 09:45:50 UTC
...
public final class mypage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\n");
      out.write("\t\n");
      out.write("\t<div class=\"btn-group-vertical\" role=\"group\" aria-label=\"...\" style =\"width: 10%; padding-top: 90px;\">\n");
      out.write("\t\t\t\t<button type=\"button\" onclick=\"location.href='mypage.jsp'\" class=\"btn btn-default\">개인정보 수정</button>\n");
      out.write("  \t\t\t\t<button type=\"button\" onclick=\"location.href='myHistory.jsp'\" class=\"btn btn-default\">게시판 게시 내역</button>\n");
      out.write("\t</div>\n");
      out.write("\t<div class=\"container\" style =\"width: 90%; float: right;\">\n");
      ...
      out.write("\t\t\t\t<h3 style=\"text-align: center;\">개인정보 수정</h3>\n");
      out.write("\t\t\t\t<div class =\"form-group\">\n");
      out.write("\t\t\t\t\t<label for=\"userID\">아이디 </label>\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"변경하실 아이디를 입력해주세요 \" name=\"userID\" maxlength=\"20\" value =\"");
      out.print( userinfo.getUserID() );
      out.write("\" > \n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class =\"form-group\">\n");
      out.write("\t\t\t\t\t<label for=\"userPassword\">비밀번호 </label>\n");
      out.write("\t\t\t\t\t<input type=\"password\" class=\"form-control\" placeholder=\"변경하실 비밀번호를 입력해주세요 \" name=\"userPassword\" maxlength=\"20\" > \n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class =\"form-group\">\n");
      out.write("\t\t\t\t\t<label for=\"userPasswordCheck\">비밀번호 확인 </label>\n");
      out.write("\t\t\t\t\t<input type=\"password\" class=\"form-control\" placeholder=\"변경하실 비밀번호를 확인해주세요\" name=\"userPasswordCheck\" maxlength=\"20\"  > \n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class =\"form-group\">\n");
      out.write("\t\t\t\t\t<label for=\"userName\">이름 </label>\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"변경하실 이름을 입력해주세요\" name=\"userName\" maxlength=\"20\" value =\"");
      out.print( userinfo.getUserName() );
      out.write("\" > \n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class =\"form-group\" style=\"text-align: center;\">\n");
      out.write("\t\t\t\t\t\t<label class=\"radio-inline active\">\n");
      out.write("\t\t\t\t\t\t\t\t  <input type=\"radio\" name=\"userGender\" value=\"남자\" checked> 남자 \n");
      out.write("\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"radio-inline\">\n");
      out.write("\t\t\t\t\t\t\t\t  <input type=\"radio\" name=\"userGender\" value=\"여자\"> 여자\n");
      out.write("\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</div> \n");
      out.write("\t\t\t\t</div>\t\t\n");
      out.write("\t\t\t\t<div class =\"form-group\" >\n");
      out.write("\t\t\t\t\t<label for=\"userEmail\">이메일 </label>\n");
      out.write("\t\t\t\t\t\t<input type=\"email\" class=\"form-control\" placeholder=\"변경하실 이메일을 입력해주세요  \" name=\"userEmail\" maxlength=\"20\" value =\"");
      out.print( userinfo.getUserEmail() );
      out.write("\" >\n");
      out.write("\t\t\t\t\t</div>\t\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t<input type =\"submit\" class=\"btn btn-primary form-control\" value=\"수정\">\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t<div class =\"col-lg-4\"></div>\n");
      out.write("\t</div>\n");
      out.write("\t\n");
