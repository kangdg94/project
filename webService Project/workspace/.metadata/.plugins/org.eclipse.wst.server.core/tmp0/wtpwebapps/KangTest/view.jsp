	...
	<div class="container">
		<div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<thread>
					<tr>
						<th colspan="3" style="background-color: #bbbbbb; text-align: center;">게시판 글보기 양식</th>
					</tr>
				</thread>
				<tbody>
					<tr>
                    ...
                    <tr>
                        ...
                        if (bbs.getFileName() != null ){
                        	out.write("<a href=\"" + request.getContextPath() + "/downloadAction?file=" + 
                        			java.net.URLEncoder.encode(bbs.getFileName(), "UTF-8") + "\">" + bbs.getFileName() + "</a><br>");
                        }
